...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    var seletor = document.getElementsByClassName("randomPizzaContainer");
    var tamanho = seletor.length;
    var dx = determineDx(seletor[0], size);
    var newwidth = seletor[0].offsetWidth + dx + 'px';
    for (var i = 0; i < tamanho; i++) {
      seletor[i].style.width = newwidth;
    }
  }
